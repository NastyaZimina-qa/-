...
bot = TeleBot(token='5807135885:AAG0Y4FbLDE0q38j9juSMwAwm6aJ01mWvqQ', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я бот помощник. Я помогу тебе проверить JSON и форматировать его в красивый текст\nВведи JSON в виде строки:', # текст сообщения
    )
...
def message_handler(message: types.Message):
    try:
        ...
        bot.send_message(
            ...
            text=f'УПС! При обработке произошла ошибка:\n<code>{str(ex)}</code>'
        )
        # выходим из функции
        return
